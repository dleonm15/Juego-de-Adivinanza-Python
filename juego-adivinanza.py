...
print("\nBienvenido al juego de \"Adivina el número secreto\", en este juego deberás adivinar un número al azar entre el 1 y 99 en un máximo de 10 intentos" )

while not numero_adivinado:
    if not cant_intentos < cant_max_intentos:
        print("\n¡Game Over! No has podido adivinar el número secreto dentro de los 10 intentos\n")
        break
